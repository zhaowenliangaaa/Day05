...
<body class="gray-bg">
        ...
        <div class="row">
			  ...
			  <div class="col-lg-2">
				<div class="input-group">
					...
					<select class="form-control" name="txt_search_depid" id = "txt_search_depid">
	...
	<!-- 新增和修改对话框 -->
	<div class="modal fade" id="modal_emp_edit" role="dialog" aria-labelledby="modal_emp_edit" aria-hidden="true">
				...
				<div class="modal-body">
					<form id="form_user" method="post" action="reserveEmp.htm" enctype="multipart/form-data">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								<td>生日：</td>
								<td><input type="text" id="birthday" name="birthday" aria-required="true" required/></td>
								<td>性别：</td>
								<td>
								    <input type="radio" id="gender1" name="gender" value="男" aria-required="true" required/>男
									<input type="radio" id="gender2" name="gender" value="女" aria-required="true" required/>女
								</td>		
							</tr>
							<tr>
								<td>头像：</td>
								<td>
									<img alt="" src="" id="pics" width="30px" height="30px">
									<input type="file" name="picFile" id="picFile">
									<input type="hidden" name="pic" >
								</td>
								<td>部门：</td>
								<td>
									<select name="depid" id = "depid" aria-required="true" required>
	...
	<!--删除对话框 -->
	<div class="modal fade" id="modal_emp_del" role="dialog" aria-labelledby="modal_emp_del" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
	...
	<!--导入对话框 -->
	<div class="modal fade" id="modal_emp_import" role="dialog" aria-labelledby="modal_emp_import" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					 <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
	...
	<!--导出对话框 -->
	<div class="modal fade" id="modal_emp_export" role="dialog" aria-labelledby="modal_emp_export" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					 <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
	...
	var ButtonInit = function () {
	    ...
	    oInit.Init = function () {
	    	...
	    	$("#btn_add").click(function(){
	    		...
	    		$('#modal_emp_edit').modal({backdrop: 'static', keyboard: false});
				$('#modal_emp_edit').modal('show');
	        });
	    	...
	    	$("#btn_delete").click(function(){
	    		...
	    		if(getSelections && getSelections.length>0){
	    			$('#modal_emp_del').modal({backdrop: 'static', keyboard: false});
	    			$("#modal_emp_del").show();
	    		}else{
	    	...
	    	$("#btn_import").click(function(){
	    			$('#modal_emp_import').modal({backdrop: 'static', keyboard: false});
	    			$("#modal_emp_import").show();
	        });
	    	//导出弹框
	    	$("#btn_export").click(function(){
	    			$('#modal_emp_export').modal({backdrop: 'static', keyboard: false});
	    			$("#modal_emp_export").show();
	        });
