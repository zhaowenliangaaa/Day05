...
<body class="gray-bg">
        ...
        <div class="row">
			  ...
			  <div class="col-lg-2">
				<div class="input-group">
					 ...
					 <input placeholder="生日" readonly="readonly" id="starttime" name="starttime" class="laydate-icon form-control layer-date"/>
					 <input placeholder="生日" readonly="readonly" id="endtime" name="endtime" class="laydate-icon form-control layer-date"/>
				</div>
			 </div>
	...
	<!-- 新增和修改对话框 -->
	<div class="modal fade" id="modal_person_edit" role="dialog" aria-labelledby="modal_person_edit" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_user" method="post" action="reservePerson.htm" enctype="multipart/form-data">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								...
								<td>&nbsp;&nbsp;</td>
								<td>人员性别：
								    <input type="radio" id="sex1" name="sex" value="男"  aria-required="true" required/>男
									<input type="radio" id="sex2" name="sex" value="女"  aria-required="true" required/>女
								</td>
							...
							<tr>
								<td>年龄：</td>
								<td>
									<input type="text" id="age" name="age" class="form-control" aria-required="true" required/>
								</td>
								<td>生日：</td>
								<td>
									 <input placeholder="生日" id="birthday" name="birthday" class="laydate-icon form-control layer-date"/>
								</td>
							</tr>
							<tr>
								<td>头像：</td>
	...
	<!--删除对话框 -->
	<div class="modal fade" id="modal_person_del" role="dialog" aria-labelledby="modal_person_del" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-footer">
				<button type="button" class="btn btn-danger"  id="del_person_btn">刪除</button>
	...
	var ButtonInit = function () {
	    ...
	    oInit.Init = function () {
	    	...
	    	$("#btn_add").click(function(){
	    		...
	    		$('#modal_person_edit').modal({backdrop: 'static', keyboard: false});
				$('#modal_person_edit').modal('show');
	        });
	    	...
	    	$("#btn_delete").click(function(){
	    		...
	    		if(getSelections && getSelections.length>0){
	    			$('#modal_person_del').modal({backdrop: 'static', keyboard: false});
	    			$("#modal_person_del").show();
	    		}else{
